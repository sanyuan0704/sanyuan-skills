...
- [ ] Step 1: Understand the Skill [WARN] REQUIRED
...
- [ ] Step 3: Initialize [STOP] BLOCKING (skip if skill already exists)
  - [ ] Run init_skill.py
...
## Step 3: Initialize [STOP] BLOCKING
...
- [WARN] REQUIRED for steps that must not be skipped
- [STOP] BLOCKING for prerequisites
...
- [ ] Has a trackable workflow checklist with [WARN]/[STOP] markers
