...
- [ ] Step 1: Setup & Analyze
  ...
  - [ ] 1.2 Analyze content
  - [ ] 1.3 Check existing [WARN] REQUIRED
- [ ] Step 2: Confirmation [WARN] REQUIRED
...
|--------|---------|-------------|
| [WARN] REQUIRED | Must not skip | User confirmation, critical validation |
| [STOP] BLOCKING | Must complete before proceeding | Prerequisite setup, dependency loading |
...
```markdown
- [ ] Step 0: Check preferences [STOP] BLOCKING
...
- [ ] Step 5: Present findings [WARN] REQUIRED
...
[WARN] Do NOT proceed without explicit user confirmation.
```
...
```markdown
## Step 0: Load Preferences [STOP] BLOCKING
